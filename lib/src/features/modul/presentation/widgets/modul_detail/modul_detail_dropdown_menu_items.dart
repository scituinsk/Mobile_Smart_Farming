...
abstract class ModulDetailDropdownMenuItems {
  static MenuItem get modulLogs =>
      MenuItem(text: "device_history_menu".tr, icon: LucideIcons.scrollText);
  static MenuItem get editIcon =>
      MenuItem(text: "edit_device_menu".tr, icon: Icons.edit);
  static MenuItem get deleteIcon =>
      MenuItem(text: "delete_device_menu".tr, icon: Icons.delete_rounded);
  static MenuItem get editPasswordIcon =>
      MenuItem(text: "edit_password_menu".tr, icon: Icons.key);
  ...
  static Widget buildItem(MenuItem item) {
    return item.text == deleteIcon.text
        ? Row(
            spacing: 10.r,
            children: [
              MyIcon(
  ...
  static void onChanged(BuildContext context, MenuItem item) {
    ...
    } else if (item.text == deleteIcon.text) {
      CustomDialog.show(
        context: context,
        dialogMargin: 35,
    ...
    } else if (item.text == editPasswordIcon.text) {
    ...
    } else if (item.text == modulLogs.text) {
      Get.back();
